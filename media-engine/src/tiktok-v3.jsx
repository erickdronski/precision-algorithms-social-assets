...
//   - A closing CTA beat: the plate is covered, the desk lockup lands, "Five free previews a day",
  ...
  const nodes=[
    ...
    <column name="bubble" x={110} y={700} width={W-220} radius={28} fill={CARD} at={0.35} duration={T1-0.35}
      ...
      <column padding={{top:34,bottom:40,left:40,right:40}} gap={18}>
        ...
        <text width={W-300} align="center" fontFamily="Satoshi" fontSize={28} fontWeight={500} color={MUTE}>{S.venue+" vs. the Precision model"}</text>
      </column>
    </column>,
    ...
    <text x={M} y={1260} width={CW} fontFamily="General Sans" fontSize={72} fontWeight={700} color={WHITE} lineHeight={1.08} at={T1+0.15} duration={T2-T1-0.15}
    ...
    <text x={80} y={800} width={W-160} align="center" fontFamily="General Sans" fontSize={62} fontWeight={700} color={WHITE} lineHeight={1.12} at={T3+0.25} duration={life(T3+0.25)}
